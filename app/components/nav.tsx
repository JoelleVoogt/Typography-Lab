  ...
  return (
    <header className="top-0 z-50 bg-cream w-full">
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-4 py-4">
        <div className="bg-[#1a1a1a] w-[53px] h-12 flex items-center justify-center rounded-md shrink-0">
          <span
        ...
        <div className="flex items-center gap-[10px] sm:gap-8">
          {["Family", "Weights", "Playground"].map((item) => (
            <a
              ...
              className="text-[#1a1a1a] text-md md:text-lg leading-none font-display"
              style={{ fontVariationSettings: FV }}
            >
              {item}
            </a>
