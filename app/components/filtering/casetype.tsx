...
export default function CaseType({
  ...
  return (
    <Select.Root defaultValue="Sentence case" onValueChange={onValueChange}>
      <Select.Trigger className="place-content-between xl:place-content-start border-b border-b-[#54544D] xl:border-b-0 border-r-0 xl:border-r xl:border-r-[#54544d] flex gap-2 h-14 items-center px-4 w-full xl:w-sm outline-none cursor-default data-[state=open]:bg-[rgba(235,234,212,0.2)]">
        <Select.Value />
        <Select.Icon asChild>
