...
export default function Playground() {
  ...
  return (
    <section id="playground" className="max-w-7xl mx-auto px-4 pt-20 pb-60">
      <div
        className={`border-2 border-cream bg-[#222221] rounded-2xl py-20 sm:py-30 px-6 sm:px-8 flex items-center justify-center overflow-hidden cursor-text transition-shadow duration-100 ${
          focused
